...
public class OVRLipSyncTestAudio : MonoBehaviour 
{
	...
	void Start () 
	{
        ...
        /*
         * Commented by Ivan. This was downgraded to ActiveMQ version, maybe a
         * compatibility error due to Unity versions?
         * In any case, web audio is not used in this project.
